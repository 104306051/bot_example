...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerDialog() : base(new QnAMakerService(new QnAMakerAttribute(Utils.GetAppSetting("QnASubscriptionKey"),
             Utils.GetAppSetting("QnAKnowledgebaseId"), "我聽不懂嗚嗚", 0.5)))
        {}
    }
}